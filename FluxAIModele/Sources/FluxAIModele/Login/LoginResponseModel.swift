...
//  FluxAIModele
//
//  Created by Er Baghdasaryan on 11.03.25.
//
...
public struct LoginData: Codable {
    public let id: Int
    public let userID, gender, source: String
    public let isNewRegistered: Bool
    public let stat: Stat
    public let avatars: [JSONAny]

    public enum CodingKeys: String, CodingKey {
        case id
        case userID = "userId"
        case gender, source, isNewRegistered, stat, avatars
    }
}
...
public struct Stat: Codable {
    ...
    public let maxPhotos, maxStyles, maxModels: Int?
    public let isActiveTariff: Bool?
    public let tariffID: Int?
    public let maxUploadPhotos, minUploadPhotos: Int?
    public let totalGenerations, totalGenerationsTemplate, totalGenerationsGod: Int
    public let totalModels, availableModels, availableGenerations: Int

    public enum CodingKeys: String, CodingKey {
        case startAt, maxPhotos, maxStyles, maxModels, isActiveTariff
        case tariffID = "tariffId"
        case maxUploadPhotos, minUploadPhotos, totalGenerations, totalGenerationsTemplate, totalGenerationsGod, totalModels, availableModels, availableGenerations
    }
}
