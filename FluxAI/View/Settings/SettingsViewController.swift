...
extension SettingsViewController {
    ...
    private func configureCorners(for cell: UICollectionViewCell, indexPath: IndexPath) {
        ...
        bottomView.backgroundColor = UIColor(hex: "#A09E9E")
        ...
        if section == 0 && row == 0 {
            ...
            cell.contentView.layer.maskedCorners = [.layerMaxXMinYCorner, .layerMinXMinYCorner, .layerMinXMaxYCorner, .layerMaxXMaxYCorner]
